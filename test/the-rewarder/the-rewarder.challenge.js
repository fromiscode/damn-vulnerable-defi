...
describe('[Challenge] The rewarder', function () {
    ...
    it('Exploit', async function () {
        ...
        Exploit = await ethers.getContractFactory('TheRewarderExploit', attacker);
        exploit = await Exploit.deploy(this.flashLoanPool.address, this.liquidityToken.address, this.rewarderPool.address, this.rewardToken.address);
