...
describe('[Challenge] Backdoor', function () {
    ...
    it('Exploit', async function () {
        ...
        Exploit = await ethers.getContractFactory('BackdoorExploit', attacker);
        exploit = await Exploit.deploy()
        tx = await exploit.exploit(users, this.token.address, this.walletFactory.address, this.masterCopy.address, this.walletRegistry.address, attacker.address);
        await tx.wait();
    });
