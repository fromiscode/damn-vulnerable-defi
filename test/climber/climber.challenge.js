...
describe('[Challenge] Climber', function () {
    ...
    it('Exploit', async function () {        
        ...
        Exploit = await ethers.getContractFactory('ClimberExploit', attacker);
        exploit = await Exploit.deploy();
        tx = await exploit.exploit(this.timelock.address, this.vault.address, this.token.address, attacker.address);
        await tx.wait();
    });
